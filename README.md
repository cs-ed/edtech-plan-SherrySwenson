...
Regardless of whether we are in person or remote, I will use evidence based practices as we work together on the basics of the problem and then break up into groups for peer instruction.  Later in the project, we will come back together to share out solutions.  Another strategy to incorporate will be pair programming.  This will allow students to take turns as the "driver" and the "navigator" and practice these abilities in projects.
