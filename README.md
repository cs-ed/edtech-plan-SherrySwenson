...
From the teacher's perspective, I will need to be cognizant not to expect a background connection from my learners and instead, I will need to build background with clear definitions of terms and practices, avoiding extraneous 
